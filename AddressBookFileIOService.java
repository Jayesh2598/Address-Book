...
public class AddressBookFileIOService {
	...
	public static String AddressBookFile = "src/com/capgemini/addressBook/AddressBook-File.txt";
	...
	public List<String> readFile() {
		...
		try {
			fileEntries = Files.lines(new File(AddressBookFile).toPath()).map(line -> line.trim()).collect(Collectors.toList());
		} catch (IOException e) {
			e.printStackTrace();
		}
		return fileEntries;
